  ...
  it('exposes every verb with a request + response schema', () => {
    ...
    expect(names).toMatchInlineSnapshot(`
      [
        ...
        "loginSession.update",
        "maestro.acceptSuggestion",
        "maestro.approveAction",
        "maestro.dismissSuggestion",
        "maestro.getPrompts",
        "maestro.getSession",
        "maestro.getState",
        "maestro.getSuggestion",
        "maestro.listActions",
        "maestro.regenerateSuggestion",
        "maestro.reportActivity",
        "maestro.revertAction",
        "maestro.runNow",
        "maestro.setMode",
        "maestro.setPaused",
        "maestro.setPrompts",
        ...
        "session.setJiraTaskId",
        "session.setLoginSessionId",
